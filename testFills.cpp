...
//     PNG img;
//     img.readFromFile("originals/cqdog.png");

//     animation anim;
//     anim = filler::fillCustomDFS(img, 200, 50, RAINTOLERANCE, 1000);
//     PNG result = anim.write("images/dfsdog.gif");
//     result.writeToFile("images/dfsdog.png");
//     PNG expected; expected.readFromFile("soln_images/bfsrain.png");
//     REQUIRE(result==expected);
// }
...
//     animation anim;
//     anim = filler::fillCustomBFS(img, 200, 50, RAINTOLERANCE,1000);
//     PNG result = anim.write("images/bfsdog.gif");
//     result.writeToFile("images/bfsdog.png");
//     PNG expected; expected.readFromFile("soln_images/bfsrain.png");
//     REQUIRE(result==expected);
// }
// TEST_CASE("fill::pikachu dfs","[weight=1][part=fill]"){
//     PNG img;
//     img.readFromFile("originals/1.png");
//     HSLAPixel px(40., 1.0, 0.5);

//     animation anim;
//     anim = filler::fillStripeDFS(img, 250, 250, px, 5,
//                                      GRIDTOLERANCE, 1000);
//     PNG result = anim.write("images/pd.gif");
//     result.writeToFile("images/pd.png");
//     PNG expected; expected.readFromFile("soln_images/bfsrain.png");
//     REQUIRE(result==expected);
// }

// TEST_CASE("fill::pikachu bfs","[weight=1][part=fill]"){
//     PNG img;
//     img.readFromFile("originals/1.png");
//     HSLAPixel px(200., 1.0, 0.5);

//     animation anim;
//     anim = filler::fillStripeBFS(img, 250, 250, px, 5,
//                                      GRIDTOLERANCE,1000);
//     PNG result = anim.write("images/pb.gif");
//     result.writeToFile("images/pb.png");
//     PNG expected; expected.readFromFile("soln_images/bfsrain.png");
//     REQUIRE(result==expected);
// }
...
//     PNG img;
//     img.readFromFile("originals/2.png");

//     animation anim;
//     anim = filler::fillCustomDFS(img, 20, 20, RAINTOLERANCE, 1000);
//     PNG result = anim.write("images/ad.gif");
//     result.writeToFile("images/ad.png");
//     PNG expected; expected.readFromFile("soln_images/bfsrain.png");
//     REQUIRE(result==expected);
// }
// TEST_CASE("fill::basic custom bfs","[weight=1][part=fill]"){
...
//     animation anim;
//     anim = filler::fillCustomBFS(img, 20, 20, RAINTOLERANCE,1000);
//     PNG result = anim.write("images/ab.gif");
//     result.writeToFile("images/ab.png");
//     PNG expected; expected.readFromFile("soln_images/bfsrain.png");
//     REQUIRE(result==expected);
// }